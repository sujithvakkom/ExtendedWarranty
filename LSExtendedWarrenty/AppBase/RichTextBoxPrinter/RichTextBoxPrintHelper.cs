...
namespace LSExtendedWarrenty.AppBase.RichTextBoxPrinter
{
    class RichTextBoxPrintHelper
    {
        ...
        // Added Following 2 properties

        public void ApplyPageSettings(System.Drawing.Printing.PageSettings pagesettings)
        {
            _pagesettings = pagesettings;

        }
        public void ApplyPrintSettings(System.Drawing.Printing.PrinterSettings printsettings)
        {
            _printsettings = printsettings;
        }
        public Exception GetHelperException()
        {
            return _helperexception;
        }
        public PrinterSettings _printsettings;
        public PageSettings _pagesettings;
        public Exception _helperexception = null; // Default No exception
        // end additions
        ...
        public void PreviewRTF()
        {
            PreviewRTF(new PrintDocument());
        }
        public void PrintRTF(PrintDocument printDocument)
        {
            ...
            try
            {
                ...
                //printDocument.PrinterSettings = _printsettings;
        ...
        public void PreviewRTF(PrintDocument printDocument)
        {
            try
            {
                printDocument.BeginPrint += new System.Drawing.Printing.PrintEventHandler(this.printDocument_BeginPrint);
